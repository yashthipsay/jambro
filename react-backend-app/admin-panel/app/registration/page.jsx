...
const Autocomplete = dynamic(() => import('@/app/components/ui/autocomplete'), {
  ssr: false,
});

const OlaMap = dynamic(() => import('@/app/components/ui/olaMap'), {
  ssr: false,
});
...
const JamRoomRegistration = () => {
  ...
  const uploadImagesToS3 = async () => {
    ...
    try {
      ...
      const response = await fetch('https://api.vision.gigsaw.co.in/api/jamrooms/images', {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await fetch('https://api.vision.gigsaw.co.in/api/jamrooms/create', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor="jamroom" className="text-white">
                          Jam Room
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                ...
                <TabsContent value="additional" className="mt-4 sm:mt-6 space-y-4 sm:space-y-6">
                  <div className="space-y-4 sm:space-y-6">
                    <div>
                      <Label
                        htmlFor="images"
                        className="text-white text-lg mb-2 block flex items-center"
                      >
                      ...
                      <div className="mt-1 flex items-center justify-center w-full">
                        <label className="flex flex-col items-center justify-center w-full h-36 border-2 border-dashed rounded-lg cursor-pointer bg-black/30 hover:bg-black/40 border-[#7DF9FF]/30">
                          <div className="flex flex-col items-center justify-center pt-5 pb-6">
                            <svg
                              className="w-10 h-10 mb-3 text-[#7DF9FF]"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            ...
                            <p className="text-xs text-[#7DF9FF]/80">
